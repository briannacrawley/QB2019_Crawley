...
> ***Answer 2a***:  Species richness is fairly low at the earliest sampled sites; richness is highest downstream, with the exception of the 23-25 samples.
> ***Answer 2b***:  Brown trout is largely absent from downstream sites;
> ***Answer 2c***:  
